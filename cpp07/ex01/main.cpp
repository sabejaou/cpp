...
// Exemple de fonction à appliquer à chaque élément du tableau (incrémentation)
template <typename T>
...
int main() {
    ...
    // Test 3: Tableau de chaînes de caractèresssss
    ...
    // Test 4: Tableau de caractères
    char charArray[] = {'a', 'b', 'c', 'd', 'e'};
    size_t charArraySize = sizeof(charArray) / sizeof(charArray[0]);

    std::cout << "\nTest 4 - Tableau de caractères avant incrémentation: ";
